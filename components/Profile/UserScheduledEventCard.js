...
const UserScheduledEventCard = (event) => {
                ...
                <div class="profile-list">
                    ...
                    <div class="inner-content">
                        ...
                        <div class="scheduled-event-list-action-container">
                            <button data-event-category-id=${event.eventCategoryId} class="action-btn-admin write-event-review-btn">
    ...
    const writeReviewBtn = content.querySelector(".write-event-review-btn")
    if (writeReviewBtn) writeReviewBtn.onclick = () => createWriteReviewOverlay(event.orderId)
    return content
}

export default UserScheduledEventCard